		...
		class Freemius_Debug_Bar_Panel extends Debug_Bar_Panel {
			...
			public function render() {
				...
				<div id='debug-bar-php'>
					<?php /* phpcs:ignoreFile */ fs_require_template( '/debug/api-calls.php' ) ?>
					<br>
					<?php /* phpcs:ignoreFile */ fs_require_template( '/debug/scheduled-crons.php' ) ?>
					<br>
					<?php /* phpcs:ignoreFile */ fs_require_template( '/debug/plugins-themes-sync.php' ) ?>
					<br>
					<?php /* phpcs:ignoreFile */ fs_require_template( '/debug/logger.php' ) ?>
				</div>
			<?php /* phpcs:ignoreFile */
			}
		}
