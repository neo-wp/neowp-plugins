<?php /* phpcs:ignoreFile */ if (!defined("ABSPATH")) { die("neoWP direct access not allowed"); }
	/**
	 * IMPORTANT:
    ...
    if ( ! function_exists( 'fs_fallback_to_newest_active_sdk' ) ) {
        ...
        function fs_fallback_to_newest_active_sdk() {
            ...
            if ( is_null( $newest_sdk_data ) ) {
                ...
                $fs_active_plugins = (object) ["plugins" => []]; // plugins -> Leeres SDK-Array beibehalten, damit ein direkt folgender Uninstall-Aufruf die Referenz erneut sicher entfernen kann
                update_option( 'fs_active_plugins', $fs_active_plugins );
            } else {
