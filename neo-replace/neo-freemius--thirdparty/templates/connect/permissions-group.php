...
?>
<div class="fs-permissions-section fs-<?php /* phpcs:ignoreFile */ echo esc_attr( $permission_group[ 'id' ] ) ?>-permissions">
    <div>
        <div class="fs-permissions-section--header">
            <a class="fs-group-opt-out-button"
                data-type="<?php /* phpcs:ignoreFile */ echo esc_attr( $permission_group['type'] ) ?>"
                data-group-id="<?php /* phpcs:ignoreFile */ echo esc_attr( $permission_group[ 'id' ] ) ?>"
                data-is-enabled="<?php /* phpcs:ignoreFile */ echo $is_enabled ? 'true' : 'false' ?>"
                href="#"><?php /* phpcs:ignoreFile */ echo esc_html( $is_enabled ? $opt_out_text : $opt_in_text ) ?></a>
            <span class="fs-permissions-section--header-title"><?php /* phpcs:ignoreFile */
                    // The title is already HTML-escaped.
                    echo $permission_group[ 'title' ]
                ?></span>
        </div>
        <p class="fs-permissions-section--desc"><?php /* phpcs:ignoreFile */
