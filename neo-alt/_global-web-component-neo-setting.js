export default class NeoSetting extends HTMLElement {
    ...
    connectedCallback() {
        this.setAttribute("data-neo-global--setting-style-scope", "neo-alt");
        if (!document.querySelector("style#data-neo-global--setting-style-scope-neo-alt")) {
            const style = document.createElement("style");
            style.id = "data-neo-global--setting-style-scope-neo-alt";
            style.innerHTML = `
            [data-neo-global--setting-style-scope="neo-alt"] {
