        ...
        this.shadowRoot.innerHTML = `
            <style>
                ...
                .trigger {
                    ...
                    border: 1px solid var(--neo-select-border-color-neo-alt, #A0A0A0); border-radius: var(--neo-select-border-radius-neo-alt, 4px);
                    background: var(--neo-select-background-neo-alt, #ffffff); color: inherit; font: inherit;
                    padding: var(--neo-select-padding-neo-alt, 0.45em 1.9em 0.45em 0.65em); cursor: pointer; text-align: left; white-space: nowrap;
                }
...
if (!customElements.get("neo-select-neo-alt")) { customElements.define("neo-select-neo-alt", NeoSelect); }
