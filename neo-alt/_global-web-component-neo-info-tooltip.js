...
const MARGIN_PX            = 10;
const BODY_CSS_ID          = "neo-info-tooltip-global-styles-neo-alt";
...
export default class NeoInfoTooltip extends HTMLElement {
  ...
  connectedCallback () {
    ...
    this._tooltipEl.classList.add("neo-global--tooltip-neo-alt");
    this._closeEl.classList.add("neo-global--close-neo-alt");
