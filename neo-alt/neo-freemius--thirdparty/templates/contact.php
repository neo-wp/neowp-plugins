		...
		<script type="text/javascript">
			(function ($) {
				$(function () {
					...
					frame_height = 800,
					base_url = '<?php /* phpcs:ignoreFile */ echo WP_FS__ADDRESS ?>',
					src = base_url + '/contact/?<?php /* phpcs:ignoreFile */ echo http_build_query($query_params) ?>#' + encodeURIComponent(document.location.href),
