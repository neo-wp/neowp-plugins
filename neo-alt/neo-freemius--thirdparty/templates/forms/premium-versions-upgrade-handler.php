    ...
    $( document ).ready(function() {
        ...
        var modalContentHtml = <?php /* phpcs:ignoreFile */ echo json_encode( $modal_content_html ) ?>,
            modalHtml        =
                ...
                + '         <a href="!#" class="fs-close"><i class="dashicons dashicons-no" title="<?php /* phpcs:ignoreFile */ echo esc_js( fs_text_x_inline( 'Dismiss', 'close a window', 'dismiss', $slug ) ) ?>"></i></a>'
                + '     </div>'
                + '     <div class="fs-modal-body">'
                + '         <div class="fs-modal-panel active">' + modalContentHtml + '</div>'
                + '     </div>'
                + '     <div class="fs-modal-footer">'
                + '         <a class="button button-primary button-renew-license" tabindex="3" href="<?php /* phpcs:ignoreFile */ echo $purchase_url ?>"><?php /* phpcs:ignoreFile */ echo esc_js( $renew_license_button_text ) ?></a>'
                ...
                + '</div>',
            $modal           = $( modalHtml ),
            isPluginsPage    = <?php /* phpcs:ignoreFile */ echo Freemius::is_plugins_page() ? 'true' : 'false' ?>;
