export default class NeoSetting extends HTMLElement {
    ...
    connectedCallback() {
        this.setAttribute("data-neo-global--setting-style-scope", "neo-rename");
        if (!document.querySelector("style#data-neo-global--setting-style-scope-neo-rename")) {
            const style = document.createElement("style");
            style.id = "data-neo-global--setting-style-scope-neo-rename";
            style.innerHTML = `
            [data-neo-global--setting-style-scope="neo-rename"] {
