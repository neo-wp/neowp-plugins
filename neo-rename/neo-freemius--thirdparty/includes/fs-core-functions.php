<?php /* phpcs:ignoreFile */
    ...
    if ( ! function_exists( 'fs_ui_get_action_button' ) ) {
        ...
        function fs_ui_action_link( $module_id, $page, $action, $title, $params = array() ) {
            ?><a class=""
                 href="<?php /* phpcs:ignoreFile */ echo wp_nonce_url( freemius( $module_id )->_get_admin_page_url( $page, array_merge( $params, array( 'fs_action' => $action ) ) ), $action ) ?>"><?php /* phpcs:ignoreFile */ echo $title ?></a><?php /* phpcs:ignoreFile */
        }
    }
