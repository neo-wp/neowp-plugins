            ...
            $cloneResolutionNotice.on( 'click', '.button, #fs_temporary_duplicate_license_activation_link', function( evt ) {
                ...
                var $body             = $( 'body' ),
                    ...
                    beforeUnload      = function() {
                        return '<?php /* phpcs:ignoreFile */ fs_esc_js_echo_inline( 'Please wait', 'please-wait' ) ?>';
                    };
                ...
                $.ajax( {
                    ...
                    method    : 'POST',
                    data      : {
                        action      : '<?php /* phpcs:ignoreFile */ echo $VARS['ajax_action'] ?>',
                        security    : '<?php /* phpcs:ignoreFile */ echo wp_create_nonce( $VARS['ajax_action'] ) ?>',
