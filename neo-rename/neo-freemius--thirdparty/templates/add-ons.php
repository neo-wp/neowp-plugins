...
?>
	<div id="fs_addons" class="wrap fs-section">
		<?php /* phpcs:ignoreFile */ if ( ! $has_tabs ) : ?>
		<h2><?php /* phpcs:ignoreFile */ echo esc_html( sprintf( fs_text_inline( 'Add Ons for %s', 'add-ons-for-x', $slug ), $fs->get_plugin_name() ) ) ?></h2>
		<?php /* phpcs:ignoreFile */ endif ?>

		<?php /* phpcs:ignoreFile */ $fs->do_action( 'addons/after_title' ) ?>

		<div id="poststuff">
			<?php /* phpcs:ignoreFile */ if ( ! $has_addons ) : ?>
				<h3><?php /* phpcs:ignoreFile */ echo esc_html( sprintf(
						'%s... %s',
			...
			<ul class="fs-cards-list">
				<?php /* phpcs:ignoreFile */ if ( $has_addons ) : ?>
                    ...
                    ?>
					<?php /* phpcs:ignoreFile */ foreach ( $addons as $addon ) : ?>
						<?php /* phpcs:ignoreFile */
						...
						?>
						<li class="fs-card fs-addon" data-slug="<?php /* phpcs:ignoreFile */ echo $addon->slug ?>">
							<?php /* phpcs:ignoreFile */
							...
							<div class="fs-inner">
								<ul>
									<li class="fs-card-banner"
                                        style="background-image: url('<?php /* phpcs:ignoreFile */ echo $addon->info->card_banner_url ?>');"><?php /* phpcs:ignoreFile */
                                        ...
                                        ?></li>
									<!-- <li class="fs-tag"></li> -->
									<li class="fs-title"><?php /* phpcs:ignoreFile */ echo $addon->title ?></li>
									<li class="fs-offer">
									<span
										class="fs-price"><?php /* phpcs:ignoreFile */
                                        if ( $is_whitelabeled ) {
                                            echo '&nbsp;';
                                        } else {
											$descriptors = array();
									...
									<li class="fs-description"><?php /* phpcs:ignoreFile */ echo ! empty( $addon->info->short_description ) ? $addon->info->short_description : 'SHORT DESCRIPTION' ?></li>
                                    <?php /* phpcs:ignoreFile */
                                    ...
                                    ?>
                                    <?php /* phpcs:ignoreFile */ if ( ! $show_premium_activation_or_installation_action ) : ?>
									<li class="fs-cta"><a class="button"><?php /* phpcs:ignoreFile */ echo esc_html( $view_details_text ) ?></a></li>
                                    <?php /* phpcs:ignoreFile */ else : ?>
                                        ...
                                        <div class="button-group">
                                            <?php /* phpcs:ignoreFile */ if ( $is_allowed_to_install ) : ?>
                                            <?php /* phpcs:ignoreFile */
                                            ...
                                            ?>
                                            <?php /* phpcs:ignoreFile */ else : ?>
                                            <a target="_blank" rel="noopener" class="button button-primary" href="<?php /* phpcs:ignoreFile */ echo $latest_download_local_url ?>"><?php /* phpcs:ignoreFile */ echo esc_html( $download_latest_text ) ?></a>
                                            <?php /* phpcs:ignoreFile */ endif ?>
                                            <div class="button button-primary fs-dropdown-arrow-button"><span class="fs-dropdown-arrow"></span><ul class="fs-dropdown-list" style="display: none">
		                                            <?php /* phpcs:ignoreFile */ if ( $is_allowed_to_install && ! empty( $latest_download_local_url ) ) : ?>
			                                            <li><a target="_blank" rel="noopener" href="<?php /* phpcs:ignoreFile */ echo $latest_download_local_url ?>"><?php /* phpcs:ignoreFile */ echo esc_html( $download_latest_text ) ?></a></li>
		                                            <?php /* phpcs:ignoreFile */ endif ?>
		                                            <li><?php /* phpcs:ignoreFile */
				                                            echo sprintf(
					                                            $view_details_link,
					                                            /**
					                                             * No additional class.
		...
		<?php /* phpcs:ignoreFile */ $fs->do_action( 'addons/after_addons' ) ?>
	</div>
	<script type="text/javascript">
		(function( $, undef ) {
			...
			<?php /* phpcs:ignoreFile */ if ( $open_addon ) : ?>
			...
			var interval = setInterval(function () {
				 ...
				 */
				?>
				$('.fs-card[data-slug=<?php /* phpcs:ignoreFile */ echo $open_addon_slug ?>] a').click();
