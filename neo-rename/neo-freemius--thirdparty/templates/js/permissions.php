...
<script type="text/javascript">
    ( function ( $ ) {
        ...
        function getOptInLabel( isEnabled ) {
            return isEnabled ?
                '<?php /* phpcs:ignoreFile */ echo esc_js( fs_text_x_inline( 'Opt In', 'verb', 'opt-in' ) ) ?>' :
                '<?php /* phpcs:ignoreFile */ echo esc_js( fs_text_x_inline( 'Opt Out', 'verb', 'opt-out' ) ) ?>';
        }
                ...
                updatePermissions: function(
                    ...
                    $.ajax( {
                        ...
                        data    : {
                            ...
                            module_id       : pluginID,
                            _wp_http_referer: '<?php /* phpcs:ignoreFile */ echo Freemius::current_page_url() ?>',
                ...
                $modal.on( 'click', '.fs-permissions .fs-switch', function () {
                    ...
                    FS.Permissions.updatePermissions(
                        ...
                        function () {
                            ...
                            $switchFeedback.html( '<i class="dashicons dashicons-yes"></i> <?php /* phpcs:ignoreFile */ echo esc_js( fs_text_inline( 'Saved', 'saved' ) ) ?>' );
