		...
		$( '.fs-notice.fs-sticky .fs-close' ).click(function() {
			...
			notice.fadeOut( 'fast', function() {
				var data = {
                    ...
                    _wpnonce : <?php /* phpcs:ignoreFile */ echo wp_json_encode( wp_create_nonce( 'fs_dismiss_notice_action' ) ); ?>,
					message_id: id
				};

				$.post( <?php /* phpcs:ignoreFile */ echo Freemius::ajax_url() ?>, data, function( response ) {
