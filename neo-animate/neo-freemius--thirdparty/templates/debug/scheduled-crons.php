...
?>
<?php /* phpcs:ignoreFile */ if ( $is_fs_debug_page ) : ?>
<h2>
    <button class="fs-debug-table-toggle-button" aria-expanded="true">
        <span class="fs-debug-table-toggle-icon">▼</span>
    </button>
    <?php /* phpcs:ignoreFile */ fs_esc_html_echo_inline( 'Scheduled Crons' ) ?>
</h2>
<?php /* phpcs:ignoreFile */ else : ?>
<h1><?php /* phpcs:ignoreFile */ fs_esc_html_echo_inline( 'Scheduled Crons' ) ?></h1>
<?php /* phpcs:ignoreFile */ endif ?>
<table class="widefat fs-debug-table">
	<thead>
	<tr>
		<th><?php /* phpcs:ignoreFile */ fs_esc_html_echo_inline( 'Slug' ) ?></th>
		<th><?php /* phpcs:ignoreFile */ fs_esc_html_echo_inline( 'Module' ) ?></th>
		<th><?php /* phpcs:ignoreFile */ fs_esc_html_echo_inline( 'Module Type' ) ?></th>
		<th><?php /* phpcs:ignoreFile */ fs_esc_html_echo_inline( 'Cron Type' ) ?></th>
		<th><?php /* phpcs:ignoreFile */ fs_esc_html_echo_inline( 'Last' ) ?></th>
		<th><?php /* phpcs:ignoreFile */ fs_esc_html_echo_inline( 'Next' ) ?></th>
	</tr>
	</thead>
	<tbody>
	<?php /* phpcs:ignoreFile */
	...
	?>
	<?php /* phpcs:ignoreFile */ foreach ( $scheduled_crons as $slug => $crons ) : ?>
		<?php /* phpcs:ignoreFile */ foreach ( $crons as $cron ) : ?>
			<tr>
				<td><?php /* phpcs:ignoreFile */ echo $slug ?></td>
				<td><?php /* phpcs:ignoreFile */ echo $cron['name'] ?></td>
				<td><?php /* phpcs:ignoreFile */ echo $cron['module_type'] ?></td>
				<td><?php /* phpcs:ignoreFile */ echo $cron['type'] ?></td>
