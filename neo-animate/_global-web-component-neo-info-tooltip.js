...
const MARGIN_PX            = 10;
const BODY_CSS_ID          = "neo-info-tooltip-global-styles-neo-animate";
  ...
  connectedCallback () {
    ...
    if (!document.getElementById(BODY_CSS_ID)) {
      ...
      globalCss.textContent =`
        .neo-global--tooltip-neo-animate{
    ...
    this._tooltipEl.classList.add("neo-global--tooltip-neo-animate");
    this._closeEl.classList.add("neo-global--close-neo-animate");
