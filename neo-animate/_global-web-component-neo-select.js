        ...
        this.shadowRoot.innerHTML = `
            <style>
                ...
                .trigger {
                    ...
                    border: 1px solid var(--neo-select-border-color-neo-animate, #A0A0A0); border-radius: var(--neo-select-border-radius-neo-animate, 4px);
                    background: var(--neo-select-background-neo-animate, #ffffff); color: inherit; font: inherit;
                    padding: var(--neo-select-padding-neo-animate, 0.45em 1.9em 0.45em 0.65em); cursor: pointer; text-align: left; white-space: nowrap;
                }
...
if (!customElements.get("neo-select-neo-animate")) { customElements.define("neo-select-neo-animate", NeoSelect); }
