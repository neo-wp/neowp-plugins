        ...
        this.shadowRoot.innerHTML = `
            <style>
                ...
                .trigger {
                    ...
                    border: 1px solid var(--neo-select-border-color-neo-optimize, #A0A0A0); border-radius: var(--neo-select-border-radius-neo-optimize, 4px);
                    background: var(--neo-select-background-neo-optimize, #ffffff); color: inherit; font: inherit;
                    padding: var(--neo-select-padding-neo-optimize, 0.45em 1.9em 0.45em 0.65em); cursor: pointer; text-align: left; white-space: nowrap;
                }
...
if (!customElements.get("neo-select-neo-optimize")) { customElements.define("neo-select-neo-optimize", NeoSelect); }
