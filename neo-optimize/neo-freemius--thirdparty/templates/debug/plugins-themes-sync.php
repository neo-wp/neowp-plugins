...
?>
<h1><?php /* phpcs:ignoreFile */ fs_esc_html_echo_inline( 'Plugins & Themes Sync', 'plugins-themes-sync' ) ?></h1>
<table class="widefat">
	<thead>
	<tr>
		<th></th>
		<th><?php /* phpcs:ignoreFile */ fs_esc_html_echo_inline( 'Total', 'total' ) ?></th>
		<th><?php /* phpcs:ignoreFile */ fs_esc_html_echo_inline( 'Last', 'last' ) ?></th>
	</tr>
	</thead>
	<tbody>
	<?php /* phpcs:ignoreFile */ if ( is_object( $all_plugins ) ) : ?>
		<tr>
			<td><?php /* phpcs:ignoreFile */ fs_esc_html_echo_inline( 'Plugins', 'plugins' ) ?></td>
			<td><?php /* phpcs:ignoreFile */ echo count( $all_plugins->plugins ) ?></td>
	...
	<?php /* phpcs:ignoreFile */ if ( is_object( $all_themes ) ) : ?>
		<tr>
			<td><?php /* phpcs:ignoreFile */ fs_esc_html_echo_inline( 'Themes', 'themes' ) ?></td>
			<td><?php /* phpcs:ignoreFile */ echo count( $all_themes->themes ) ?></td>
			<td><?php /* phpcs:ignoreFile */
