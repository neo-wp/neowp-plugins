export default class NeoSetting extends HTMLElement {
    ...
    connectedCallback() {
        this.setAttribute("data-neo-global--setting-style-scope", "neo-optimize");
        if (!document.querySelector("style#data-neo-global--setting-style-scope-neo-optimize")) {
            const style = document.createElement("style");
            style.id = "data-neo-global--setting-style-scope-neo-optimize";
            style.innerHTML = `
            [data-neo-global--setting-style-scope="neo-optimize"] {
