...
function _register_js_permission($function_name) {
    ...
    \NeoDuplicate\NeoGlobal\add_action_hook("init", function () use (&$function_name) {
        \NeoDuplicate\NeoGlobal\enqueue_js_variable_backend(lcfirst(str_replace("_", "", ucwords($function_name, "_"))), (__NAMESPACE__ . "\\" . $function_name)());
    });
}
