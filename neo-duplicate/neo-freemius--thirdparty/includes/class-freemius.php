...
------------------------------------------------------------------------------------------------------------------*/
        ...
        private function register_constructor_hooks() {
            ...
            if ( is_admin() ) {
                ...
                if ( $this->is_plugin() ) {
                    if ( self::is_plugin_install_page() && true !== fs_request_get_bool( 'fs_allow_updater_and_dialog' ) ) {
                         ...
                         */
                        add_filter( 'site_transient' . '_update_plugins', array( 'Freemius', '_remove_fs_updates_from_plugin_install_page' ), 10, 2 );
                     ...
                     */
                    // HOOK TAKEN OVER BY NEOWP #neoFreemiusActivationDeactivationUninstallHooks register_activation_hook(
                        // HOOK TAKEN OVER BY NEOWP #neoFreemiusActivationDeactivationUninstallHooks $plugin_dir . $this->_free_plugin_basename,
                        // HOOK TAKEN OVER BY NEOWP #neoFreemiusActivationDeactivationUninstallHooks array( &$this, '_activate_plugin_event_hook' )
                    // HOOK TAKEN OVER BY NEOWP #neoFreemiusActivationDeactivationUninstallHooks );

                    // HOOK TAKEN OVER BY NEOWP #neoFreemiusActivationDeactivationUninstallHooks register_activation_hook(
                        // HOOK TAKEN OVER BY NEOWP #neoFreemiusActivationDeactivationUninstallHooks $plugin_dir . $this->premium_plugin_basename(),
                        // HOOK TAKEN OVER BY NEOWP #neoFreemiusActivationDeactivationUninstallHooks array( &$this, '_activate_plugin_event_hook' )
                    // HOOK TAKEN OVER BY NEOWP #neoFreemiusActivationDeactivationUninstallHooks );
                } else {
            ...
            if ( $this->is_plugin() ) {
                ...
                // HOOK TAKEN OVER BY NEOWP #neoFreemiusActivationDeactivationUninstallHooks register_deactivation_hook( $this->_plugin_main_file_path, array( &$this, '_deactivate_plugin_hook' ) );
            }
        ...
        private function register_after_settings_parse_hooks() {
            ...
            if (
                ...
                // HOOK TAKEN OVER BY NEOWP #neoFreemiusActivationDeactivationUninstallHooks register_activation_hook(
                    // HOOK TAKEN OVER BY NEOWP #neoFreemiusActivationDeactivationUninstallHooks dirname( $this->_plugin_dir_path ) . '/' . $this->_premium_plugin_basename,
                    // HOOK TAKEN OVER BY NEOWP #neoFreemiusActivationDeactivationUninstallHooks array( &$this, '_activate_plugin_event_hook' )
                // HOOK TAKEN OVER BY NEOWP #neoFreemiusActivationDeactivationUninstallHooks );
            }
        }
        ...
        static function _prepend_fs_allow_updater_and_dialog_flag_url_param() {
            ...
            <script type="text/javascript">
            (function( $ ) {
                var slugBasenameMap = <?php /* phpcs:ignoreFile */ echo json_encode( $slug_basename_map ) ?>;
        ...
        static function _maybe_add_beta_label_to_plugins_and_handle_confirmation() {
            ...
            <script type="text/javascript">
                ( function( $ ) {
                    var betaData = <?php /* phpcs:ignoreFile */ echo json_encode( $beta_data ) ?>;
                    ...
                    for ( var pluginBasename in betaData ) {
                        ...
                        $parentContainer.find( '.plugin-title > strong:first-child').append(
                            '<span class="fs-tag fs-info"><?php /* phpcs:ignoreFile */ fs_esc_js_echo_inline( 'Beta', 'beta' ) ?></span>'
                        );
                    }
         ...
         * @since  1.2.0
         */
        private function unregister_uninstall_hook() { return; // NEOWP TAKES OVER UNINSTALL HOOKS, SO THIS FUNCTION COULD ONLY MAYBE BREAK THINGS #neoFreemiusActivationDeactivationUninstallHooks
        ...
        /**
         * @since 1.2.0 Invalidate module's main file cache, otherwise, FS_Plugin_Neo_Updater will not fetch updates.
         *
        ...
        function _submit_uninstall_reason_action() {
            ...
            if ( $this->is_theme() ) {
                if ( $this->is_premium() && ! $this->has_active_valid_license() ) {
                    FS_Plugin_Neo_Updater::instance( $this )->delete_update_data();
                }
...
//				}
            ...
            if (
                ...
                FS_Plugin_Neo_Updater::instance( $this );
            }
            ...
            <script type="text/javascript">// <![CDATA[
                jQuery(document).ready(function ($) {
                    if ('undefined' !== typeof(jQuery().pointer)) {
                        ...
                        var element = <?php /* phpcs:ignoreFile */ echo $this->apply_filters( 'optin_pointer_element', '$("#non_existing_element");' ) ?>;

                        if (element.length > 0) {
                            var optin = $(element).pointer($.extend(true, {}, {
                                content     : <?php /* phpcs:ignoreFile */ echo json_encode( $pointer_content ) ?>,
                                position    : {
                                    edge : 'left',
                                    align: 'center'
                                },
                                ...
                                pointerWidth: 482
                            }, <?php /* phpcs:ignoreFile */ echo $this->apply_filters( 'optin_pointer_options_json', '{}' ) ?>));
...
//				$this->sync_install( array(), true );
                ...
                if ( WP_FS__DEV_MODE ||
                    ...
                    // $this->reset_anonymous_mode( $network ); // COMMENTED OUT BY NEOWP #neoFreemiusRemoveOptInReset
                }
            }
        ...
        function _deactivate_plugin_hook() {
            ...
            // HOOK TAKEN OVER BY NEOWP #neoFreemiusActivationDeactivationUninstallHooks register_uninstall_hook( $this->_plugin_main_file_path, array( 'Freemius', '_uninstall_plugin_hook' ) );
...
//            }
        ...
        function set_basename( $is_premium, $caller ) {
            ...
            // HOOK TAKEN OVER BY NEOWP #neoFreemiusActivationDeactivationUninstallHooks register_activation_hook(
                // HOOK TAKEN OVER BY NEOWP #neoFreemiusActivationDeactivationUninstallHooks $plugin_dir . $basename,
                // HOOK TAKEN OVER BY NEOWP #neoFreemiusActivationDeactivationUninstallHooks array( &$this, '_activate_plugin_event_hook' )
            // HOOK TAKEN OVER BY NEOWP #neoFreemiusActivationDeactivationUninstallHooks );
        }
...
//			}
        ...
        function _install_premium_version_ajax_action() {
            ...
            $updater = FS_Plugin_Neo_Updater::instance( $this );
