<?php /* phpcs:ignoreFile */
	...
	if ( is_object($update) ) {
         ...
         * @since  2.0.0
         */
		$updater = FS_Plugin_Neo_Updater::instance( $fs );
...
?>
	<div class="wrap fs-section">
		<?php /* phpcs:ignoreFile */ if ( ! $has_tabs && ! $fs->apply_filters( 'hide_account_tabs', false ) ) : ?>
		<h2 class="nav-tab-wrapper">
			<a href="<?php /* phpcs:ignoreFile */ echo esc_url( $fs->get_account_url() ) ?>"
			   class="nav-tab nav-tab-active"><?php /* phpcs:ignoreFile */ fs_esc_html_echo_inline( 'Account', 'account', $slug ) ?></a>
			<?php /* phpcs:ignoreFile */ if ( $fs->has_addons() ) : ?>
				<a href="<?php /* phpcs:ignoreFile */ echo esc_url( $fs->_get_admin_page_url( 'addons' ) ) ?>"
				   class="nav-tab"><?php /* phpcs:ignoreFile */ echo esc_html( $addons_text ) ?></a>
			<?php /* phpcs:ignoreFile */ endif ?>
			<?php /* phpcs:ignoreFile */ if ( $show_upgrade ) : ?>
				<a href="<?php /* phpcs:ignoreFile */ echo esc_url( $fs->get_upgrade_url() ) ?>" class="nav-tab"><?php /* phpcs:ignoreFile */ echo esc_html( $upgrade_text ) ?></a>
				<?php /* phpcs:ignoreFile */ if ( $fs->apply_filters( 'show_trial', true ) && ! $fs->is_trial_utilized() && $fs->has_trial_plan() ) : ?>
					<a href="<?php /* phpcs:ignoreFile */ echo esc_url( $fs->get_trial_url() ) ?>" class="nav-tab"><?php /* phpcs:ignoreFile */ fs_esc_html_echo_inline( 'Free Trial', 'free-trial', $slug ) ?></a>
				<?php /* phpcs:ignoreFile */ endif ?>
			<?php /* phpcs:ignoreFile */ endif ?>
		</h2>
		<?php /* phpcs:ignoreFile */ endif ?>
			...
			<div id="fs_account">
				<div class="has-sidebar has-right-sidebar">
					<div class="has-sidebar-content">
						<div class="postbox">
							<h3><span class="dashicons dashicons-businessman"></span> <?php /* phpcs:ignoreFile */ fs_esc_html_echo_inline( 'Account Details', 'account-details', $slug ) ?></h3>
							<div class="fs-header-actions">
								<ul>
                                    <?php /* phpcs:ignoreFile */ if ( $fs->is_whitelabeled( true ) ) : ?>
                                        <li>
                                            <a href="#" class="debug-license-trigger"><i class="dashicons dashicons-<?php /* phpcs:ignoreFile */ echo $is_whitelabeled ? 'editor-code' : 'controls-pause' ?>"></i> <span><?php /* phpcs:ignoreFile */
                                                if ( $is_whitelabeled ) {
                                        ...
                                        <li>&nbsp;&bull;&nbsp;</li>
                                    <?php /* phpcs:ignoreFile */ endif ?>
									<?php /* phpcs:ignoreFile */ if ( $show_billing ) : ?>
                                        <li><a href="#fs_billing"><i class="dashicons dashicons-portfolio"></i> <?php /* phpcs:ignoreFile */ fs_esc_html_echo_inline( 'Billing & Invoices', 'billing-invoices', $slug ) ?></a></li>
										<li>&nbsp;&bull;&nbsp;</li>
									<?php /* phpcs:ignoreFile */ endif ?>
                                    <?php /* phpcs:ignoreFile */ if ( ! $is_whitelabeled ) : ?>
                                        <?php /* phpcs:ignoreFile */ if ( ! $is_paying ) : ?>
                                            <li>
                                                <?php /* phpcs:ignoreFile */
                                                    $view_params = array(
                                                        'freemius'          => $fs,
                                        ...
                                        <?php /* phpcs:ignoreFile */ endif ?>
                                        <?php /* phpcs:ignoreFile */ if ( $is_paying ) : ?>
                                            <?php /* phpcs:ignoreFile */ if ( ! fs_is_network_admin() ) : ?>
                                            <li>
                                                <form action="<?php /* phpcs:ignoreFile */ echo esc_url( $fs->_get_admin_page_url( 'account' ) ) ?>" method="POST">
                                                    <input type="hidden" name="fs_action" value="deactivate_license">
                                                    <?php /* phpcs:ignoreFile */ wp_nonce_field( 'deactivate_license' ) ?>
                                                    <a href="#" class="fs-deactivate-license"><i
                                                            class="dashicons dashicons-admin-network"></i> <?php /* phpcs:ignoreFile */ fs_echo_inline( 'Deactivate License', 'deactivate-license', $slug ) ?>
                                                    </a>
                                                </form>
                                            </li>
                                            <li>&nbsp;&bull;&nbsp;</li>
                                            <?php /* phpcs:ignoreFile */ endif ?>
                                            <?php /* phpcs:ignoreFile */ if ( ! $license->is_lifetime() &&
                                                       $is_active_subscription
                                            ) : ?>
                                                <li>
                                                    <form action="<?php /* phpcs:ignoreFile */ echo esc_url( $fs->_get_admin_page_url( 'account' ) ) ?>" method="POST">
                                                        <input type="hidden" name="fs_action" value="downgrade_account">
                                                        <?php /* phpcs:ignoreFile */ wp_nonce_field( 'downgrade_account' ) ?>
                                                        <a href="#"
                                                           onclick="if ( confirm('<?php /* phpcs:ignoreFile */ echo esc_attr( sprintf(
                                                           ...
                                                           ) ) ?> <?php /* phpcs:ignoreFile */ if ( ! $license->is_block_features ) {
                                                           ...
                                                           }?> <?php /* phpcs:ignoreFile */ echo esc_attr( $prices_increase_text ) ?> <?php /* phpcs:ignoreFile */ fs_esc_attr_echo_inline( 'Are you sure you want to proceed?', 'proceed-confirmation', $slug ) ?>') ) this.parentNode.submit(); return false;"><i class="dashicons dashicons-download"></i> <?php /* phpcs:ignoreFile */ echo esc_html( $fs->is_only_premium() ? fs_text_inline( 'Cancel Subscription', 'cancel-subscription', $slug ) : $downgrade_text ) ?></a>
                                                    </form>
                                                </li>
                                                <li>&nbsp;&bull;&nbsp;</li>
                                            <?php /* phpcs:ignoreFile */ endif ?>
                                            <?php /* phpcs:ignoreFile */ if ( $is_plan_change_supported ) : ?>
                                                <li>
                                                    <a href="<?php /* phpcs:ignoreFile */ echo esc_url( $fs->get_upgrade_url() ) ?>"><i
                                                            class="dashicons dashicons-grid-view"></i> <?php /* phpcs:ignoreFile */ echo esc_html( $change_plan_text ) ?></a>
                                                </li>
                                                <li>&nbsp;&bull;&nbsp;</li>
                                            <?php /* phpcs:ignoreFile */ endif ?>
                                        <?php /* phpcs:ignoreFile */ elseif ( $is_paid_trial ) : ?>
                                            <li>
                                                <form action="<?php /* phpcs:ignoreFile */ echo esc_url( $fs->_get_admin_page_url( 'account' ) ) ?>" method="POST">
                                                    <input type="hidden" name="fs_action" value="cancel_trial">
                                                    <?php /* phpcs:ignoreFile */ wp_nonce_field( 'cancel_trial' ) ?>
                                                    <a href="#" class="fs-cancel-trial"><i
                                                            class="dashicons dashicons-download"></i> <?php /* phpcs:ignoreFile */ echo esc_html( $cancel_trial_text ) ?></a>
                                                </form>
                                            </li>
                                            <li>&nbsp;&bull;&nbsp;</li>
                                        <?php /* phpcs:ignoreFile */ endif ?>
                                    ...
                                    <li>
                                        <form action="<?php /* phpcs:ignoreFile */ echo esc_url( $fs->_get_admin_page_url( 'account' ) ) ?>" method="POST">
                                            <input type="hidden" name="fs_action" value="<?php /* phpcs:ignoreFile */ echo esc_attr( $fs->get_unique_affix() ) ?>_sync_license">
                                            <?php /* phpcs:ignoreFile */ wp_nonce_field( $fs->get_unique_affix() . '_sync_license' ) ?>
                                            <a href="#" onclick="this.parentNode.submit(); return false;"><i
                                                    class="dashicons dashicons-image-rotate"></i> <?php /* phpcs:ignoreFile */ fs_esc_html_echo_x_inline( 'Sync', 'as synchronize', 'sync', $slug ) ?></a>
                                        </form>
                                    </li>
								</ul>
							</div>
								...
								<table id="fs_account_details" cellspacing="0" class="fs-key-value-table">
									...
									<?php /* phpcs:ignoreFile */ $odd = true;
										foreach ( $profile as $p ) : ?>
											...
											?>
											<tr class="fs-field-<?php /* phpcs:ignoreFile */ echo esc_attr( $p['id'] ) ?><?php /* phpcs:ignoreFile */ if ( $odd ) : ?> alternate<?php /* phpcs:ignoreFile */ endif ?>">
												<td>
													<nobr><?php /* phpcs:ignoreFile */ echo esc_html( $p['title'] ) ?><?php /* phpcs:ignoreFile */ echo ( ! empty( $p['title'] ) ) ? ':' : '' ?></nobr>
												</td>
												<td<?php /* phpcs:ignoreFile */ if ( 'plan' === $p['id'] || 'bundle_plan' === $p['id'] ) { echo ' colspan="2"'; }?>>
													<?php /* phpcs:ignoreFile */ if ( in_array( $p['id'], array( 'license_key', 'site_secret_key' ) ) ) : ?>
														<code><?php /* phpcs:ignoreFile */ echo FS_Plugin_License::mask_secret_key_for_html( $p['value'] ) ?></code>
														<?php /* phpcs:ignoreFile */ if ( ! $is_whitelabeled ) : ?>
                                                        <input type="text" value="<?php /* phpcs:ignoreFile */ echo htmlspecialchars( $p['value'] ) ?>" style="display: none"
														       readonly/>
                                                        <?php /* phpcs:ignoreFile */ endif ?>
                                                    <?php /* phpcs:ignoreFile */ elseif ( 'beta_program' === $p['id'] ) : ?>
                                                        <label>
                                                            <input type="checkbox" class="fs-toggle-beta-mode" <?php /* phpcs:ignoreFile */ checked( true, $p['value'] ) ?>/><span><?php /* phpcs:ignoreFile */
                                                                fs_esc_html_echo_inline( 'Join the Beta program', 'join-beta', $slug )
                                                        ?></span></label>
													<?php /* phpcs:ignoreFile */ else : ?>
														<code><?php /* phpcs:ignoreFile */ echo htmlspecialchars( $p['value'] ) ?></code>
													<?php /* phpcs:ignoreFile */ endif ?>
													<?php /* phpcs:ignoreFile */ if ( 'email' === $p['id'] && ! $user->is_verified() ) : ?>
														<label class="fs-tag fs-warn"><?php /* phpcs:ignoreFile */ fs_esc_html_echo_inline( 'not verified', 'not-verified', $slug ) ?></label>
													<?php /* phpcs:ignoreFile */ endif ?>
													<?php /* phpcs:ignoreFile */ if ( 'plan' === $p['id'] ) : ?>
														<?php /* phpcs:ignoreFile */ if ( $fs->is_trial() ) : ?>
															<label class="fs-tag fs-success"><?php /* phpcs:ignoreFile */ echo esc_html( $trial_text ) ?></label>
														<?php /* phpcs:ignoreFile */ endif ?>
														<?php /* phpcs:ignoreFile */ if ( is_object( $license ) && ! $license->is_lifetime() ) : ?>
															<?php /* phpcs:ignoreFile */ if ( ! $is_active_subscription && ! $is_active_bundle_subscription && ! $license->is_first_payment_pending() ) : ?>
                                                                <?php /* phpcs:ignoreFile */ $is_license_expired = $license->is_expired() ?>
                                                                <?php /* phpcs:ignoreFile */ $expired_ago_text   = ( fs_text_inline( 'Expired', 'expired', $slug ) . ' ' . fs_text_x_inline( '%s ago', 'x-ago', $slug ) ) ?>
																<label
																	class="fs-tag <?php /* phpcs:ignoreFile */ echo $is_license_expired ? 'fs-error' : 'fs-warn' ?>"><?php /* phpcs:ignoreFile */
                                                                    ...
                                                                    ?></label>
															<?php /* phpcs:ignoreFile */ elseif ( $is_active_subscription && ! $subscription->is_first_payment_pending() ) : ?>
																<label class="fs-tag fs-success"><?php /* phpcs:ignoreFile */ echo esc_html( sprintf( $renews_in_text, human_time_diff( time(), strtotime( $subscription->next_payment ) ) ) ) ?></label>
															<?php /* phpcs:ignoreFile */ endif ?>
														<?php /* phpcs:ignoreFile */ elseif ( $fs->is_trial() ) : ?>
															<label class="fs-tag fs-warn"><?php /* phpcs:ignoreFile */ echo esc_html( sprintf( $expires_in_text, human_time_diff( time(), strtotime( $site->trial_ends ) ) ) ) ?></label>
														<?php /* phpcs:ignoreFile */ endif ?>
                                                        <?php /* phpcs:ignoreFile */ if ( ! $is_whitelabeled ) : ?>
														<div class="button-group">
                                                            <?php /* phpcs:ignoreFile */ if ( is_object( $available_license ) ) : ?>
                                                                <?php /* phpcs:ignoreFile */
                                                                $view_params = array(
                                                                    'freemius'     => $fs,
                                                                    'slug'         => $slug,
															...
															<?php /* phpcs:ignoreFile */ else : ?>
																<form action="<?php /* phpcs:ignoreFile */ echo esc_url( $fs->_get_admin_page_url( 'account' ) ) ?>"
																      method="POST" class="button-group">
																	<?php /* phpcs:ignoreFile */ if ( $show_upgrade && $is_premium ) : ?>
																		<a class="button activate-license-trigger <?php /* phpcs:ignoreFile */ echo esc_attr( $fs->get_unique_affix() ) ?>" href="#"><?php /* phpcs:ignoreFile */ fs_esc_html_echo_inline( 'Activate License', 'activate-license', $slug ) ?></a>
																	<?php /* phpcs:ignoreFile */ endif ?>
																	<input type="submit" class="button"
																	       value="<?php /* phpcs:ignoreFile */ echo esc_attr( $sync_license_text ) ?>">
																	<input type="hidden" name="fs_action"
																	       value="<?php /* phpcs:ignoreFile */ echo esc_attr( $fs->get_unique_affix() ) ?>_sync_license">
																	<?php /* phpcs:ignoreFile */ wp_nonce_field( $fs->get_unique_affix() . '_sync_license' ) ?>
																	<?php /* phpcs:ignoreFile */ if ( $show_upgrade || $is_plan_change_supported ) : ?>
																	<a href="<?php /* phpcs:ignoreFile */ echo esc_url( $fs->get_upgrade_url() ) ?>"
																	   class="button<?php /* phpcs:ignoreFile */
																		   echo $show_upgrade ?
																			   ' button-primary fs-upgrade' :
																			   ' fs-change-plan'; ?> button-upgrade"><i
																			class="dashicons dashicons-cart"></i> <?php /* phpcs:ignoreFile */ echo esc_html( $show_upgrade ? $upgrade_text : $change_plan_text ) ?></a>
																	<?php /* phpcs:ignoreFile */ endif ?>
																</form>
															<?php /* phpcs:ignoreFile */ endif ?>
														</div>
                                                        <?php /* phpcs:ignoreFile */ endif ?>
													<?php /* phpcs:ignoreFile */ elseif ( 'bundle_plan' === $p['id'] ) : ?>
														<?php /* phpcs:ignoreFile */ if ( is_object( $bundle_subscription ) ) : ?>
															<?php /* phpcs:ignoreFile */ if ( $is_active_bundle_subscription && ! $is_bundle_first_payment_pending ) : ?>
																<label class="fs-tag fs-success"><?php /* phpcs:ignoreFile */ echo esc_html( sprintf( $renews_in_text, human_time_diff( time(), strtotime( $bundle_subscription->next_payment ) ) ) ) ?></label>
															<?php /* phpcs:ignoreFile */ endif ?>
                                                        <?php /* phpcs:ignoreFile */ endif ?>
													<?php /* phpcs:ignoreFile */ elseif ( 'version' === $p['id'] && $has_paid_plan ) : ?>
														<?php /* phpcs:ignoreFile */ if ( $fs->has_premium_version() ) : ?>
															<?php /* phpcs:ignoreFile */ if ( $is_premium ) : ?>
																<label
																	class="fs-tag fs-<?php /* phpcs:ignoreFile */ echo $fs->can_use_premium_code() ? 'success' : 'warn' ?>"><?php /* phpcs:ignoreFile */ fs_esc_html_echo_inline( 'Premium version', 'premium-version', $slug ) ?></label>
															<?php /* phpcs:ignoreFile */ elseif ( $fs->can_use_premium_code() ) : ?>
																<label class="fs-tag fs-warn"><?php /* phpcs:ignoreFile */ fs_esc_html_echo_inline( 'Free version', 'free-version', $slug ) ?></label>
															<?php /* phpcs:ignoreFile */ endif ?>
														<?php /* phpcs:ignoreFile */ endif ?>
													<?php /* phpcs:ignoreFile */ endif ?>
												</td>
                                                <?php /* phpcs:ignoreFile */ if ( 'plan' !== $p['id'] && 'bundle_plan' !== $p['id'] ) : ?>
													<td class="fs-right">
														<?php /* phpcs:ignoreFile */ if ( 'email' === $p['id'] && ! $user->is_verified() ) : ?>
															<form action="<?php /* phpcs:ignoreFile */ echo $fs->_get_admin_page_url( 'account' ) ?>" method="POST">
																...
																<?php /* phpcs:ignoreFile */ wp_nonce_field( 'verify_email' ) ?>
																<input type="submit" class="button button-small"
																       value="<?php /* phpcs:ignoreFile */ fs_esc_attr_echo_inline( 'Verify Email', 'verify-email', $slug ) ?>">
															</form>
														<?php /* phpcs:ignoreFile */ endif ?>
														<?php /* phpcs:ignoreFile */ if ( 'version' === $p['id'] ) : ?>
															<?php /* phpcs:ignoreFile */ if ( $fs->has_release_on_freemius() ) : ?>
																<div class="button-group">
																	<?php /* phpcs:ignoreFile */ if ( $is_paying || $fs->is_trial() ) : ?>
																		<?php /* phpcs:ignoreFile */ if ( ! $fs->is_allowed_to_install() ) : ?>
                                                                            <a target="_blank" rel="noopener" class="button button-primary"
                                                                                href="<?php /* phpcs:ignoreFile */ echo $fs->_get_latest_download_local_url() ?>"><?php /* phpcs:ignoreFile */
                                                                            ...
                                                                            ?></a>
																		<?php /* phpcs:ignoreFile */ elseif ( is_object( $update ) ) : ?>
																			<?php /* phpcs:ignoreFile */
																			$module_type = $fs->get_module_type();
																			?>
																			<a class="button button-primary"
																			   href="<?php /* phpcs:ignoreFile */ echo wp_nonce_url( self_admin_url( "update.php?action=upgrade-{$module_type}&{$module_type}=" . $fs->get_plugin_basename() ), "upgrade-{$module_type}_" . $fs->get_plugin_basename() ) ?>"><?php /* phpcs:ignoreFile */ echo fs_esc_html_inline( 'Install Update Now', 'install-update-now', $slug ) . ' [' . $update->version . ']' ?></a>
																		<?php /* phpcs:ignoreFile */ endif ?>
																	<?php /* phpcs:ignoreFile */ endif; ?>
																</div>
															<?php /* phpcs:ignoreFile */ endif ?>
														...
														elseif ( in_array( $p['id'], array( 'license_key', 'site_secret_key' ) ) ) : ?>
                                                            <?php /* phpcs:ignoreFile */ if ( ! $is_whitelabeled && ( 'site_secret_key' === $p['id'] || ! $is_license_foreign ) ) : ?>
                                                                <button class="button button-small fs-toggle-visibility"><?php /* phpcs:ignoreFile */ fs_esc_html_echo_x_inline( 'Show', 'verb', 'show', $slug ) ?></button>
                                                            <?php /* phpcs:ignoreFile */ endif ?>
                                                            <?php /* phpcs:ignoreFile */ if ('license_key' === $p['id']) : ?>
                                                                <button class="button button-small activate-license-trigger <?php /* phpcs:ignoreFile */ echo $fs->get_unique_affix() ?>"><?php /* phpcs:ignoreFile */ fs_esc_html_echo_inline( 'Change License', 'change-license', $slug ) ?></button>
                                                            <?php /* phpcs:ignoreFile */ endif ?>
															<?php /* phpcs:ignoreFile */
														...
														( is_string( $user->secret_key ) && in_array( $p['id'], array(
                                                            ...
                                                            <?php /* phpcs:ignoreFile */ if ( 'email' !== $p['id'] || ! fs_is_network_admin() ) : ?>
															<form action="<?php /* phpcs:ignoreFile */ echo $fs->_get_admin_page_url( 'account' ) ?>" method="POST"
															      onsubmit="var val = prompt('<?php /* phpcs:ignoreFile */ echo esc_attr( sprintf(
                                                                      /* translators: %s: User's account property (e.g. name, email) */
															          fs_text_inline( 'What is your %s?', 'what-is-your-x', $slug ),
                                                                      $p['title']
                                                                  ) ) ?>', '<?php /* phpcs:ignoreFile */ echo $p['value'] ?>'); if (null == val || '' === val) return false; jQuery('input[name=fs_<?php /* phpcs:ignoreFile */ echo $p['id'] ?>_<?php /* phpcs:ignoreFile */ echo $fs->get_unique_affix() ?>]').val(val); return true;">
																<input type="hidden" name="fs_action" value="update_<?php /* phpcs:ignoreFile */ echo $p['id'] ?>">
																<input type="hidden" name="fs_<?php /* phpcs:ignoreFile */ echo $p['id'] ?>_<?php /* phpcs:ignoreFile */ echo $fs->get_unique_affix() ?>"
																       value="">
																<?php /* phpcs:ignoreFile */ wp_nonce_field( 'update_' . $p['id'] ) ?>
																<input type="submit" class="button button-small <?php /* phpcs:ignoreFile */ if ( 'email' === $p['id'] ) echo 'button-edit-email-address' ?>"
																       value="<?php /* phpcs:ignoreFile */ echo fs_esc_attr_x_inline( 'Edit', 'verb', 'edit', $slug ) ?>">
															</form>
                                                            <?php /* phpcs:ignoreFile */ endif ?>
                                                        <?php /* phpcs:ignoreFile */ elseif ( 'user_id' === $p['id'] && ! empty( $ids_of_installs_activated_with_foreign_licenses ) ) : ?>
                                                                <input id="fs_change_user" type="submit" class="button button-small"
                                                                       value="<?php /* phpcs:ignoreFile */ echo fs_esc_attr_inline( 'Change User', 'change-user', $slug ) ?>">
														<?php /* phpcs:ignoreFile */ endif ?>
													</td>
												<?php /* phpcs:ignoreFile */ endif ?>
											</tr>
						...
						<div id="fs_sites" class="postbox">
							<h3><span class="dashicons dashicons-networking"></span> <?php /* phpcs:ignoreFile */ fs_esc_html_echo_inline( 'Sites', 'sites', $slug ) ?></h3>
							<div class="fs-header-actions">
                                <?php /* phpcs:ignoreFile */ if ( ! $is_whitelabeled ) : ?>
                                    <?php /* phpcs:ignoreFile */ $has_license = is_object( $license ) ?>
                                    <?php /* phpcs:ignoreFile */ if ( $has_license || ( $show_upgrade && $is_premium ) ) : ?>
                                        <?php /* phpcs:ignoreFile */
                                        ...
                                        ?>
                                        <a class="button<?php /* phpcs:ignoreFile */ echo ( ! $has_license ? ' button-primary' : '' ) ?> activate-license-trigger <?php /* phpcs:ignoreFile */ echo $fs->get_unique_affix() ?>" href="#"><?php /* phpcs:ignoreFile */ echo $activate_license_button_text ?></a>
                                    <?php /* phpcs:ignoreFile */ endif ?>
                                <?php /* phpcs:ignoreFile */ endif ?>
								<input class="fs-search" type="text" placeholder="<?php /* phpcs:ignoreFile */ fs_esc_attr_echo_inline( 'Search by address', 'search-by-address', $slug ) ?>..."><span class="dashicons dashicons-search"></span>
							</div>
							<div class="inside">
                                <div id="" class="fs-scrollable-table">
                                    <div class="fs-table-head">
                                        <table class="widefat">
                                            <thead>
                                            <tr>
                                                <td><?php /* phpcs:ignoreFile */ fs_esc_html_echo_inline('ID', 'id', $slug) ?></td>
                                                <td><?php /* phpcs:ignoreFile */ fs_esc_html_echo_inline('Address', 'address', $slug) ?></td>
                                                <td><?php /* phpcs:ignoreFile */ fs_esc_html_echo_inline('License', 'license', $slug) ?></td>
                                                <td><?php /* phpcs:ignoreFile */ fs_esc_html_echo_inline('Plan', 'plan', $slug) ?></td>
                                                <td></td>
                                            </tr>
                                            </thead>
                                        </table>
						...
						<?php /* phpcs:ignoreFile */ endif ?>
						<?php /* phpcs:ignoreFile */ if ( 0 < count( $addons_to_show ) ) : ?>
							<!-- Add-Ons -->
							<div class="postbox">
								<div class="">
									<!--				<div class="inside">-->
									<table id="fs_addons" class="widefat">
										<thead>
										<tr>
											<th><h3><?php /* phpcs:ignoreFile */ echo esc_html( $addons_text ) ?></h3></th>
											<th><?php /* phpcs:ignoreFile */ fs_esc_html_echo_inline( 'ID', 'id', $slug ) ?></th>
											<th><?php /* phpcs:ignoreFile */ echo esc_html( $version_text ) ?></th>
											<th><?php /* phpcs:ignoreFile */ echo esc_html( $plan_text ) ?></th>
											<th><?php /* phpcs:ignoreFile */ fs_esc_html_echo_x_inline( 'License', 'as software license', 'license', $slug ) ?></th>
											<th></th>
											<?php /* phpcs:ignoreFile */ if ( $is_dev_mode ) : ?>
												<th></th>
											<?php /* phpcs:ignoreFile */ endif ?>
										</tr>
										</thead>
						...
						<?php /* phpcs:ignoreFile */ $fs->do_action( 'after_account_details' ) ?>
    ...
    <script type="text/javascript">
        (function ($) {
	        ...
	        $('.fs-toggle-visibility').click(function () {
		        ...
		        if ($input.is(':visible')) {
			        $this.html('<?php /* phpcs:ignoreFile */ fs_esc_js_echo_x_inline( 'Hide', 'verb', 'hide', $slug ) ?>');
			        setTimeout(function () {
				        $input.select().focus();
			        }, 100);
		        }
		        else {
			        $this.html( '<?php /* phpcs:ignoreFile */ fs_esc_js_echo_x_inline( 'Show', 'verb', 'show', $slug ) ?>' );
		        }
	        });
            ...
            $('.fs-toggle-tracking').click(function () {
                setLoading(
	                ...
	                ($(this).data('is-disconnected') ?
		                '<?php /* phpcs:ignoreFile */ fs_esc_js_echo_inline('Opting in', 'opting-in' ) ?>' :
		                '<?php /* phpcs:ignoreFile */ fs_esc_js_echo_inline('Opting out', 'opting-out' ) ?>') +
		                '...'
                );
            });
            ...
            $( '.fs-toggle-beta-mode' ).click( function () {
                ...
                if ( ! isChecked || confirm( '<?php /* phpcs:ignoreFile */ echo $confirmation_message ?>' ) ) {
                    $.ajax( {
                        url   : <?php /* phpcs:ignoreFile */ echo Freemius::ajax_url() ?>,
                        method: 'POST',
                        data  : {
                            action   : '<?php /* phpcs:ignoreFile */ echo $fs->get_ajax_action( 'set_beta_mode' ) ?>',
                            security : '<?php /* phpcs:ignoreFile */ echo $fs->get_ajax_security( 'set_beta_mode' ) ?>',
                            is_beta  : isChecked,
                            module_id: <?php /* phpcs:ignoreFile */ echo $fs->get_id() ?>
                        },
                        beforeSend: function () {
                            $checkbox.prop( 'disabled', true );
                            $checkbox.parent().find( 'span' ).text( '<?php /* phpcs:ignoreFile */ echo $processing_text ?>' + '...' );
                        },
                        complete: function () {
                            $checkbox.prop( 'disabled', false );
                            $checkbox.parent().find( 'span' ).text( '<?php /* phpcs:ignoreFile */ fs_esc_js_echo_inline( 'Join the Beta Program', 'join-beta', $slug ) ?>' );
                        }
                    } );
	        ...
	        $('.fs-opt-in').click(function () {
		        setLoading($(this), '<?php /* phpcs:ignoreFile */ fs_esc_js_echo_inline('Opting in', 'opting-in' ) ?>...');
	        });

	        $( '#fs_downgrade' ).submit(function( event ) {
                event.preventDefault();

		        setLoading( $( this ).find( '.button' ), '<?php /* phpcs:ignoreFile */ fs_esc_js_echo_inline( 'Downgrading', 'downgrading' ) ?>...' );
	        });

            $('.fs-activate-license').click(function () {
                setLoading($(this), '<?php /* phpcs:ignoreFile */ fs_esc_js_echo_inline('Activating', 'activating' ) ?>...');
            });

            var $deactivateLicenseOrCancelTrial = $( '.fs-deactivate-license, .fs-cancel-trial' ),
                $subscriptionCancellationModal  = $( '.fs-modal-subscription-cancellation-<?php /* phpcs:ignoreFile */ echo $fs->get_id() ?>' );

            if ( 0 !== $subscriptionCancellationModal.length ) {
                $subscriptionCancellationModal.on( '<?php /* phpcs:ignoreFile */ echo $fs->get_action_tag( 'subscription_cancellation_action' ) ?>', function( evt, cancelSubscription ) {
                    setLoading(
                        $deactivateLicenseOrCancelTrial,
                        ( ! $deactivateLicenseOrCancelTrial.hasClass( 'fs-cancel-trial' ) ?
                            '<?php /* phpcs:ignoreFile */ fs_esc_js_echo_inline( 'Deactivating', 'deactivating', $slug ) ?>' :
                            '<?php /* phpcs:ignoreFile */ echo esc_html( sprintf( fs_text_inline( 'Cancelling %s', 'cancelling-x', $slug ), fs_text_inline( 'trial', 'trial', $slug ) ) ) ?>' ) + '...'
                    );
                    ...
                    if ( false === cancelSubscription || $deactivateLicenseOrCancelTrial.hasClass( 'fs-cancel-trial' ) ) {
                        ...
                        $subscriptionCancellationModal.find( '.fs-modal-footer .button-primary' ).text( '<?php /* phpcs:ignoreFile */ echo esc_js( sprintf(
            ...
            $deactivateLicenseOrCancelTrial.click(function() {
                ...
                if ( $this.hasClass( 'fs-cancel-trial' ) ) {
                    ...
                    $subscriptionCancellationModal.find( '.fs-modal-panel > p' ).text( <?php /* phpcs:ignoreFile */ echo json_encode( $cancel_trial_confirm_text ) ?> );
                    $subscriptionCancellationModal.trigger( 'showModal' );
                } else if (confirm('<?php /* phpcs:ignoreFile */ fs_esc_attr_echo_inline( 'Deactivating your license will block all premium features, but will enable activating the license on another site. Are you sure you want to proceed?', 'deactivate-license-confirm', $slug ) ?>')) {
                    var $this = $(this);

                    if ( 0 !== $subscriptionCancellationModal.length ) {
                        $subscriptionCancellationModal.trigger( 'showModal' );
                    } else {
                        setLoading( $this, '<?php /* phpcs:ignoreFile */ fs_esc_js_echo_inline( 'Deactivating', 'deactivating', $slug ) ?>...' );
            ...
            $( '.fs-toggle-whitelabel-mode' ).click( function () {
                ...
                $.ajax( {
                    ...
                    method: 'POST',
                    data  : {
                        action   : '<?php /* phpcs:ignoreFile */ echo $fs->get_ajax_action( 'toggle_whitelabel_mode' ) ?>',
                        security : '<?php /* phpcs:ignoreFile */ echo $fs->get_ajax_security( 'toggle_whitelabel_mode' ) ?>',
                        module_id: <?php /* phpcs:ignoreFile */ echo $fs->get_id() ?>
                    },
                    beforeSend: function () {
                        $toggleLink.parent().text( '<?php /* phpcs:ignoreFile */
                            $is_whitelabeled ?
