...
(async () => {
    observeOnce("#menu-tools .wp-menu-name", async (toolsMenuNameNode) => {
        ...
        (await neoLoadInterfaceFunc("neo-duplicate", "neo-tutorial.js", "interfaceShowTutorialArrowSuppressErrorPopup20260410"))(".neo-settings--tools-menu-label", "right");
    ...
    observeOnce("#menu-tools a[href=\"tools.php?page=neowp\"]", async (neoWpMenuLinkNode) => {
        ...
        (await neoLoadInterfaceFunc("neo-duplicate", "neo-tutorial.js", "interfaceShowTutorialArrowSuppressErrorPopup20260410"))(".neo-settings--submenu-label", "right");
