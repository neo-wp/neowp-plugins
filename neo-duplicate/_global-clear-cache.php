...
function interface_all_bundles_clear_cache_20260202($force = false) {
    \NeoDuplicate\NeoGlobal\clear_plugin_cache(delete_all: false, force: $force);
}

function interface_all_bundles_clear_license_cache_20260131() {
    \NeoDuplicate\NeoGlobal\delete_all(\NeoDuplicate\NeoGlobal\cache_path("neo-pro-check"));
}
