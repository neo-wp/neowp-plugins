        ...
        this.shadowRoot.innerHTML = `
            <style>
                ...
                .trigger {
                    ...
                    border: 1px solid var(--neo-select-border-color-neo-duplicate, #A0A0A0); border-radius: var(--neo-select-border-radius-neo-duplicate, 4px);
                    background: var(--neo-select-background-neo-duplicate, #ffffff); color: inherit; font: inherit;
                    padding: var(--neo-select-padding-neo-duplicate, 0.45em 1.9em 0.45em 0.65em); cursor: pointer; text-align: left; white-space: nowrap;
                }
...
if (!customElements.get("neo-select-neo-duplicate")) { customElements.define("neo-select-neo-duplicate", NeoSelect); }
