...
const MARGIN_PX            = 10;
const BODY_CSS_ID          = "neo-info-tooltip-global-styles-neo-duplicate";
  ...
  connectedCallback () {
    ...
    if (!document.getElementById(BODY_CSS_ID)) {
      ...
      globalCss.textContent =`
        .neo-global--tooltip-neo-duplicate{
    ...
    this._tooltipEl.classList.add("neo-global--tooltip-neo-duplicate");
    this._closeEl.classList.add("neo-global--close-neo-duplicate");
