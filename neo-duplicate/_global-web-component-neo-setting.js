export default class NeoSetting extends HTMLElement {
    ...
    connectedCallback() {
        this.setAttribute("data-neo-global--setting-style-scope", "neo-duplicate");
        if (!document.querySelector("style#data-neo-global--setting-style-scope-neo-duplicate")) {
            const style = document.createElement("style");
            style.id = "data-neo-global--setting-style-scope-neo-duplicate";
            style.innerHTML = `
            [data-neo-global--setting-style-scope="neo-duplicate"] {
